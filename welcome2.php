...
<div class="bg-gray-50">
  <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
    <h2 class="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
      ...
      <span class="block text-indigo-600">Write the blog that inspire your customers.</span>
    </h2>
...
if (isset($_POST['title'])) {
  ...
  if ($conn->query($sql)) {
    # code...
    echo "<center> <b style='color:green;'> Successfully inserted </b> </center>";
  }
  else{
  ...
  <div class="md:grid md:grid-cols-3 md:gap-6">
    <div class="md:col-span-1">
      <div class="px-4 sm:px-0">
        <h3 class="text-lg font-medium leading-6 text-gray-900"> Add Blogs</h3>
        ...
        <div class="shadow sm:rounded-md sm:overflow-hidden">
          <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
            <div class="grid grid-cols-3 gap-6">
              <div class="col-span-3 sm:col-span-2">
                ...
                <div class="mt-1 flex rounded-md shadow-sm">
                  ...
                  <input type="text" name="title" id="company-website" class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300" placeholder="Write a fine title">
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div class="mt-1">
                <textarea id="about" name="description" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md" placeholder="Write something here..."></textarea>
              </div>
              <p class="mt-2 text-sm text-gray-500">Brief description for your blog.</p>
            </div>
